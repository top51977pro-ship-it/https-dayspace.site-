...
### דרך 1 — GitHub Actions (הכי פשוט, בלי להתקין כלום)

בריפו הזה יש workflow בשם **Build Android APK**.

1. נכנסים ללשונית **Actions** בגיטהאב
2. בוחרים את **Build Android APK** → **Run workflow**
3. בסיום, מורידים את הארטיפקט **dayspace-family-apk** — בתוכו `app-debug.apk`
4. מעבירים לטלפון, מאשרים "התקנה ממקור לא ידוע", ומתקינים

ה-workflow רץ גם אוטומטית בכל push שנוגע בתיקיית `app/`.
